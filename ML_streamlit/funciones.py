...
df_categorias = pd.read_parquet(r'ML_streatmlit/Datos/categorias_numeros.parquet')
df_ciudades = pd.read_parquet(r'ML_streatmlit/Datos/ciudad_numeros.parquet')
df_full_2 = pd.read_parquet(r'ML_streatmlit/Datos/df_modelo.parquet')
